  ...
  },
  {
    ...
    chapters: [
      ...
      },
      {
        ...catalog("overview"),
        no: "2.3",
        shortTitle: "실제 분석 프로세스",
        title: "실제 분석 프로세스",
        description: "분석자가 처음 여는 All Cases 화면에서 조회 조건과 Case 현황을 먼저 확인하고, 조사할 Case를 선택하는 순서를 익힙니다.",
        path: "Cases & Issues → Cases",
        learningLayout: "screen-first",
        outcomes: [
          "All Cases 화면에서 조사에 필요한 항목을 찾는다",
          "Filter, Status, Severity와 Case Domain을 순서대로 확인한다",
          "Issues 수를 확인한 뒤 조사할 Case를 선택한다",
        ],
        blocks: [
          { type: "annotatedImage", label: "화면 예시", title: "All Cases에서 조사 대상 확인", src: "./all-cases-annotated.png", alt: "Cortex XSIAM All Cases 화면의 주요 영역 9곳을 초록색 박스와 번호로 표시한 화면", caption: "All Cases 화면에서 분석에 필요한 주요 정보를 한 번에 확인할 수 있습니다." },
          { type: "callouts", title: "화면 구성 설명", items: [
            { number: "①", title: "All Cases", text: "현재 조사 대상 Case 목록입니다." },
            { number: "②", title: "Case Domain", text: "Security 또는 Posture로 구분된 Case 현황을 확인합니다." },
            { number: "③", title: "Severity", text: "Case 심각도 분포를 확인합니다." },
            { number: "④", title: "Assignee", text: "Case 담당자 현황을 확인합니다." },
            { number: "⑤", title: "Status", text: "New 또는 In Progress 등 Case 처리 상태를 확인합니다." },
            { number: "⑥", title: "Filter", text: "현재 목록에 적용된 조회 조건을 확인합니다." },
            { number: "⑦", title: "Case List", text: "목록에서 실제 조사할 Case를 선택합니다." },
            { number: "⑧", title: "Issues Breakdown", text: "각 Case에 포함된 Issue 개수를 확인합니다." },
          ]},
          { type: "flowSteps", title: "분석자가 실제 확인하는 순서", items: [
            "조회 기간(Filter) 확인",
            "Status 확인",
            "Severity 확인",
            "Case Domain 확인",
          ...
          { type: "note", tone: "tip", title: "Case를 바로 열지 않습니다", text: "분석자는 먼저 조회 기간, Severity, Status, Case Domain, Issues 수를 확인하여 우선순위를 결정한 후 조사할 Case를 선택합니다." },
        ],
      },
    ],
  },
