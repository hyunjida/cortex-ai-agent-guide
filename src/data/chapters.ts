      ...
      },
      {
        ...
        blocks: [
          ...
          { type: "cards", title: "분석 판단 기준", items: [
            ...
            { title: "Action 단계로 이동", text: "위협 활동과 영향 대상이 근거로 확인되고, 실행할 조치의 대상과 영향 및 승인 조건을 확인했을 때 대응을 검토합니다." },
          ]},
          { type: "cards", title: "다음 조사 단계 선택하기", items: [
            ...
            { title: "Response Action", text: "대상과 위협 근거가 확인되고 조치의 영향과 승인 여부를 검토한 뒤 격리·차단 등 허용된 대응으로 이동합니다." },
          ]},
          { type: "cards", title: "초보자가 많이 하는 실수", items: [
            ...
            { title: "근거 없이 Response 수행", text: "대상과 영향을 확인하지 않은 조치는 정상 업무를 중단시키거나 잘못된 대상에 적용될 수 있습니다." },
            { title: "조사 기록 없이 종료", text: "확인한 사실, 판단 근거, 수행한 조치와 후속 작업을 남기지 않으면 검토와 인수인계가 어려워집니다." },
          ]},
          { type: "note", tone: "tip", title: "다음 화면은 질문에 따라 선택합니다", text: "화면을 순서 없이 모두 열기보다 현재 답하지 못한 질문을 먼저 적으세요. 시간 순서가 필요하면 Timeline, 관계가 필요하면 Grouping Graph, 원본 데이터가 필요하면 XQL Search로 이동합니다." },
        ],
      },
    ],
  },
