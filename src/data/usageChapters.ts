...
export const usageChapters: Chapter[] = [
  ...
  {
    id: "reporting", no: "11", title: "Dashboard·Report·Widget 실제 생성", shortTitle: "Dashboards", time: "30분", audience: "SOC L2 · 관리자",
    description: "Dashboard Manager에서 Dashboard를 만들고, Widget Library와 Report Templates에서 실습 항목을 직접 생성합니다.",
    path: "왼쪽 사이드바 → Dashboards & Reports → Dashboard Manager",
    outcomes: ["Dashboard Manager에서 Dashboard를 만든다", "Widget Library에서 Custom XQL Widget을 만든다", "Report Templates에서 보고서 템플릿을 만든다"],
    blocks: [
      { type: "steps", title: "Engineer Guide · Incident Layout과 Layout Rule 생성", references: [{ chapter: "Engineer Lab 20 · Create a Custom Incident Layout and Rule", pages: "Engineer PDF 609–611쪽" }], items: [
        "Settings → Configurations → Object Setup → Incidents를 엽니다.",
        "Layouts 탭에서 New Layout을 클릭하고 이름을 입력합니다.",
        "Library에서 field와 section을 layout으로 끌어놓고 Save를 클릭합니다.",
        "Layout Rules 탭으로 이동해 New Rule을 클릭합니다.",
        "rule 조건과 적용할 incident layout을 선택한 뒤 저장합니다.",
        "조건에 맞는 incident를 열어 새 layout 적용 여부를 확인합니다.",
      ]},
      { type: "steps", title: "Engineer Guide · Dashboard 직접 생성", references: [{ chapter: "Engineer Lab 21.1 · Creating Dashboards", pages: "Engineer PDF 612–613쪽" }], items: [
        "왼쪽 사이드바에서 Dashboards & Reports를 클릭한 뒤 Dashboard Manager를 엽니다.",
        "Dashboard Manager 오른쪽 위의 + New Dashboard를 클릭합니다.",
        "Dashboard 이름을 입력하고 Dashboard type에서 Blank를 선택한 뒤 Next를 클릭합니다.",
        "PDF 실습 지시에 따라 Widget Library에서 최소 5개의 widget을 선택합니다.",
        "선택한 widget의 Data 옵션을 설정하고 Next를 클릭합니다.",
        "Edit 화면에서 widget의 위치와 크기를 조정한 뒤 저장합니다.",
        "왼쪽 사이드바의 Dashboard를 열어 방금 만든 Dashboard가 표시되는지 확인합니다.",
      ]},
      { type: "steps", title: "Engineer Guide · Report Template 직접 생성", references: [{ chapter: "Engineer Lab 21.2 · Creating Report Templates and Reports", pages: "Engineer PDF 613쪽" }], items: [
        "새로 만든 Dashboard를 연 상태에서 오른쪽 위 옵션 메뉴를 엽니다.",
        "Report Template 관련 항목을 선택하고 PDF에서 지정한 widget을 추가해 템플릿을 저장합니다.",
        "왼쪽 사이드바에서 Dashboards & Reports → Report Templates를 엽니다.",
        "저장한 template을 찾아 report 생성 절차를 실행하고 결과를 확인합니다.",
      ]},
      { type: "steps", title: "Engineer Guide · Custom XQL Widget 직접 생성", references: [{ chapter: "Engineer Lab 21.3 · Creating Widgets", pages: "Engineer PDF 613–614쪽" }], items: [
        "왼쪽 사이드바에서 Dashboards & Reports → Widget Library를 엽니다.",
        "Click to create a custom XQL widget을 선택합니다.",
        "widget 이름을 입력하고 Data Source가 XDR_DATA인지 확인합니다.",
        "Query Builder에서 XQL query를 입력하고 결과를 확인합니다.",
        "차트 유형과 표시 옵션을 설정한 뒤 widget을 저장합니다.",
        "Dashboard Manager에서 대상 Dashboard를 열고 저장한 widget을 추가합니다.",
      ]},
      { type: "note", tone: "warn", title: "현재 화면에서 생성 버튼이 보이지 않을 때", basis: "practice", text: "실무 참고: 첨부 화면처럼 기본 Dashboard가 열린 상태에서는 생성 버튼이 표시되지 않습니다. 먼저 왼쪽의 Dashboard Manager로 이동해야 합니다. Dashboard Manager에서도 + New Dashboard가 보이지 않으면 해당 테넌트의 역할·쓰기 권한 또는 관리 정책을 담당 관리자에게 확인해야 합니다. 이 권한 판단은 PDF의 클릭 절차가 아니라 현재 UI 운영을 위한 참고입니다." },
      { type: "check", title: "Dashboard 실습 확인", items: ["Dashboard가 아니라 Dashboard Manager에서 시작했다", "+ New Dashboard로 Blank Dashboard를 만들었다", "Widget Library에서 Custom XQL Widget을 만들었다", "Report Templates에서 저장한 template을 확인했다", "생성한 Dashboard를 Dashboard 화면에서 다시 열었다"] },
    ],
  },
];
