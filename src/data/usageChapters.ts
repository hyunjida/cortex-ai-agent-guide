...
export const usageChapters: Chapter[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "steps", title: "Engineer Guide · Dashboard와 Report 직접 생성", references: [{ chapter: "Engineer Lab 21 · Create Dashboards, Reports, and Widgets", pages: "Engineer PDF 612–615쪽" }], items: [
        "Dashboards & Reports → Custom Dashboards → Dashboard Manager를 엽니다.",
        "New Dashboard를 클릭하고 이름을 입력합니다.",
        "Add Widget에서 Widget Library 항목을 선택하거나 Create Custom Widget을 클릭합니다.",
        "Save를 클릭하고 Dashboard Manager에서 새 Dashboard를 다시 엽니다.",
        "Dashboards & Reports → Reports → Report Templates에서 New Template을 클릭합니다.",
        "widget과 출력 옵션을 선택해 저장하고 Generate Report로 결과를 확인합니다.",
      ]},
    ],
  },
];
